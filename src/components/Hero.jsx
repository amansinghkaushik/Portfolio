      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 z-0 overflow-visible">
          ...
          <div
            ...
            className="absolute bottom-56 text-right right-48 z-30 grid max-w-[350px] grid-cols-2 gap-y-4 text-left uppercase tracking-[0.03em] text-black/80"
          >
            <p className="text-sm font-semibold leading-[1.25]">
              Web and Mobile / UX and UI / Branding
            </p>
            <p className="text-sm font-semibold leading-[1.25]">Based in India</p>
            <p className="text-xs font-medium leading-[1.3]">
              Currently available for freelance worldwide
            </p>
            <p className="text-xs font-medium leading-[1.3]">Born in <br/> Uttar Pradesh</p>
          </div>

          {/* Testimonial/info block below meta grid */}
          <div className="absolute bottom-40 left-36 z-30 flex items-center gap-3">
            {/* Avatars */}
        ...
        <div className="relative flex h-full w-full max-w-[1280px] flex-col gap-3 lg:flex-row">
          ...
          >
            ...
            <div className="absolute bottom-16 right-0 max-w-fit text-right text-white">
              ...
              <h1 className="text-5xl font-regular italic font-serif tracking-tight sm:text-9xl">Design.</h1>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden flex gap-10 items-center rounded-xl bg-[#eaf2ff] p-7 text-[#12305f] lg:col-span-2 lg:row-span-2">
            ...
            <img className='h-48 w-48' src={astrick} alt="Astrick" />
          </div>
          ...
          <div className="flex items-center justify-center rounded-xl bg-[#eaf2ff] p-4 text-[#101828] lg:row-span-2">
            <div className="grid h-full w-full max-h-[290px] max-w-[480px] grid-cols-2 grid-rows-2 gap-x-10 gap-y-10 px-5 py-4">
              <div className="flex h-full w-full flex-col items-start justify-center text-left">
                <p className="text-4xl font-bold leading-none tracking-tight">1+</p>
                <p className="mt-1 text-sm font-semibold leading-none text-[#5c6375]">years experience</p>
              </div>
              <div className="flex h-full w-full flex-col items-start justify-center text-left">
                <p className="text-4xl font-bold leading-none tracking-tight">3+</p>
                <p className="mt-1 text-sm font-semibold leading-none text-[#5c6375]">Projects completed</p>
              </div>
              <div className="flex h-full w-full flex-col items-start justify-center text-left">
                <p className="text-4xl font-bold leading-none tracking-tight">3+</p>
                <p className="mt-1 text-sm font-semibold leading-none text-[#5c6375]">Happy clients</p>
              </div>
              <div className="flex h-full w-full flex-col items-start justify-center text-left">
                <p className="text-4xl font-bold leading-none tracking-tight">98%</p>
                <p className="mt-1 text-sm font-semibold leading-none text-[#5c6375]">On-time delivery</p>
              </div>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-xl lg:col-span-2 lg:row-span-2">
            <div
            ...
            <div className="absolute bottom-5 right-6 flex items-center gap-4 translate-y-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              ...
              <img
                src={arrowIcon}
                alt="Arrow"
                className="h-10 w-10 brightness-0 rotate-90 invert"
              />
            </div>
          </div>
          </div>
